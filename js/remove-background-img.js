...
// const canvas = document.getElementById("canvas-no-bg");
// const originalImageCanvas = document.createElement("canvas-no-bg");
// const maskCanvas = document.createElement("canvas-no-bg");
